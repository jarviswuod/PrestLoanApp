...
public class LoanController {
  ...
  public LoanResponse getLoan(
      @PathVariable @Positive(message = "loanId must be a positive number") Long loanId) {
  ...
  public PagedResponse<ScheduleRowResponse> schedulePaged(
      ...
      @RequestParam(required = false) @Min(value = 1, message = "toInstallment must be at least 1")
