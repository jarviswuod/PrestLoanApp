...
public abstract class AbstractPrepaymentComputation implements PrepaymentComputation {
  ...
  protected LoanSchedule paidInstallmentRow(List<LoanSchedule> schedules, int installmentNumber) {
  ...
  protected PrepaymentSnapshot snapshot(
      Loan loan, List<LoanSchedule> schedules, int installmentNumber) {
