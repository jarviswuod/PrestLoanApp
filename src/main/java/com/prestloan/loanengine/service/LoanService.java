...
import com.prestloan.loanengine.dto.LoanResponse;
import com.prestloan.loanengine.dto.PagedResponse;
...
public class LoanService {
    ...
    @Cacheable(
            ...
            key = "#status + '|' + #startDateFrom + '|' + #startDateTo + '|' + #page + '|' + #size + '|' + #sortBy + '|' + #sortDir",
            sync = true)
    ...
    @Cacheable(
            ...
            key = "#loanId + '|' + #status + '|' + #fromInstallment + '|' + #toInstallment + '|' + #page + '|' + #size",
            sync = true)
